    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex">
        ...
        <div className="bg-green p-12">
          ...
          <p className="font-lexend mb-7 text-offwhite">Escolha um SUV pelo seu interior espaçoso, poder e versatibilidade. Perfeito para passar as férias em família ou para aventuras off-road.</p>
        ...
        <img src={iconLuxury} alt="icones dos carros de luxo" className="mb-7" />
          ...
          <p className="font-lexend mb-7 text-offwhite">Passei nos melhores carros sem os preços exorbitantes. Desfrute do conforto aprimorado de um aluguel de luxo e chegue com estilo.</p>
